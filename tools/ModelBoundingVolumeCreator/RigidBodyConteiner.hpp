...
namespace lpt
{
    class RigidBodyContainerSingular
    {
        ...
        RigidBodyContainerSingular(std::shared_ptr<btDynamicsWorld> vWorld, btRigidBody* body, const char* name = nullptr);
    ...
    class RigidBosyContainerCreationClassThing
    {
        ...
        /// @param name name, autogenerated if nullptr
        /// @warning This does not add the body to the physics world!
        void addNewChild(btRigidBody* body, const char* name = nullptr);
